...
apt_install neofetch xclip vim tldr fuse python3 python3-venv npm zsh curl autojump fzf gpg p7zip-full nodejs eza unzip autoconf automake libtool build-essential libevent-dev libncurses5-dev libncursesw5-dev btop nvtop bat
